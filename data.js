...
NV.PROJECTS = [
 {id:'bm',icon:'brain',c1:'#6CE4F0',c2:'#1f6f8a',cats:['ai','biznes'],key:['business','memory'],
  ...
  status:{uz:'Demo konsepsiya',en:'Demo concept'}, area:{uz:'AI · Biznes',en:'AI · Business'},
 ...
 {id:'uai',icon:'spark',c1:'#B79CFF',c2:'#3d2a8a',cats:['ai','talim'],key:['universal'],
  name:{uz:'Navruz Universal AI',en:'Navruz Universal AI'},
  status:{uz:'Ishlamoqda',en:'Running'}, area:{uz:'AI yordamchi',en:'AI assistant'},
 ...
 {id:'kunim',icon:'sun',c1:'#FFD66B',c2:'#8a6a00',cats:['samaradorlik'],key:['kunim'],
  name:{uz:'KUNIM',en:'KUNIM'},
  status:{uz:'Ishlaydigan UI',en:'Working UI'}, area:{uz:'Samaradorlik',en:'Productivity'},
 ...
 {id:'sil',icon:'chart',c1:'#6CA8FF',c2:'#1d3f8a',cats:['biznes'],key:['sales','insight'],
  name:{uz:'Sales Insight Lab',en:'Sales Insight Lab'},
  status:{uz:'Tahlil loyihasi',en:'Analysis project'}, area:{uz:'Ma’lumot tahlili',en:'Data analysis'},
 ...
 {id:'ritm',icon:'pulse',c1:'#FF8A5C',c2:'#8a2d10',cats:['samaradorlik'],key:['ritm','rhythm'],
  ...
  short:{uz:'Holatingizni tanlang — ilova unga mos uchta aniq qadam beradi. Saytda jonli demo bor.',
         en:'Pick your state and the app gives you three matching steps. There’s a live demo on this site.'},
  ...
  feats:{uz:['4 ta ritm holati','Har biriga 3 ta aniq qadam','Bajarilgan qadamlar hisobi','Yengil, tez ochiladigan ilova'],
